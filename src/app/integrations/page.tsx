...
import { Bot, Cable, CheckCircle2, CircleOff, ExternalLink, MessageCircle, RadioTower, RefreshCw, Send, ShieldCheck, Smartphone, WifiOff } from 'lucide-react';
...
const platforms: PlatformCard[] = [
  ...
  { key: 'wechat_personal', name: '个人微信', adapter: 'wechatpadpro / other', configKey: 'astrbotWechatPersonalEnabled', description: '二阶段能力，实测前需要接受稳定性和合规风险。', icon: Smartphone },
];
              ...
              {loading ? (
                ...
                <>
                  ...
                  <div className="rounded-md border bg-muted/30 p-4 text-sm leading-6">
                    ...
                    <p className="text-muted-foreground">先打开 AstrBot 面板创建机器人，再接 Telegram 或 QQ OneBot。微信建议优先企业微信/公众号，个人微信放到二阶段。</p>
                  </div>
                </>
              )}
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="rounded-md border p-3">
                  <div className="text-muted-foreground">前端</div>
                  <div className="mt-1 font-medium">5000</div>
                </div>
                <div className="rounded-md border p-3">
                  <div className="text-muted-foreground">后端</div>
                  <div className="mt-1 font-medium">8000</div>
                </div>
                <div className="rounded-md border p-3">
                  <div className="text-muted-foreground">vLLM</div>
                  <div className="mt-1 font-medium">8001</div>
                </div>
                <div className="rounded-md border p-3">
                  <div className="text-muted-foreground">AstrBot</div>
                  <div className="mt-1 font-medium">6185</div>
                </div>
              </div>
